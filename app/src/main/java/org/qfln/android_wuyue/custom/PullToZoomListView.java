...
//	private LinearLayout mHeaderImage;
	...
	private void init(Context paramContext) {
		...
		//自己写的textview没有imageview
		view = LayoutInflater.from(getContext()).inflate(R.layout.profile_top, null);

		this.mHeaderImage = new ImageView(paramContext);
		////设置默认图片
		this.mHeaderImage.setImageResource(R.mipmap.bg_profile);
//		this.mHeaderImage = new LinearLayout(paramContext);
